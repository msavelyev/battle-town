...
function bulletPosition(tank, direction) {
  switch (direction) {
    case Direction.UP:
      return new Point(tank.position.x, tank.position.y);
    case Direction.DOWN:
      return new Point(tank.position.x, tank.position.y + tank.size - Bullet.size() / 2);
    case Direction.LEFT:
      return new Point(tank.position.x, tank.position.y);
    case Direction.RIGHT:
      return new Point(tank.position.x + tank.size - Bullet.size() / 2, tank.position.y);
    default:
